namespace EsericizioEuro
{
     public class Country : Territory
    {
       ...
       protected string _nome;
        ...
        public Country(int popolazione, float areaGeografica, string continente,string nome, string costituzione, string bandiera, string moneta, string linguaufficiale, float pil, bool penamorte):base(popolazione,areaGeografica,continente)
        {
